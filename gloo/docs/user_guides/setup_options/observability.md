...
Gloo can be configured to provide observability to your services.
Depending on your needs and use case, Gloo's observability features can be configured during setup or while Gloo is running.
