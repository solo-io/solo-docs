...
* [Rate-limiting service]({{< ref "/enterprise/rate_limiting/ratelimit">}}) with pluggable storage, multiple options for API (simplified, [or more flexible]({{< ref "/enterprise/rate_limiting/rate_limits_envoy">}}), depending on what you need) - enterprise feature
* [OIDC integration]({{< ref "/enterprise/authentication/oidc" >}}), pluggable [external-auth service]({{< ref "/enterprise/authentication/auth" >}}) - enterprise feature
* [Web console to manage the control plane]({{< ref "/enterprise/basic_routing_console">}}) - enterprise feature
