...
| gatewayProxies[].gatewayProxy.kind                        | object   | Kind may either be set to a Deployment or DaemonSet. Depending on which value is set the gateway-proxy pod will be deployed by a DaemonSet controller or a Deployment controller.                                                                                |
