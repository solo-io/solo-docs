---
title: "Extending Gloo with Go Plugins"
weight: 2
---

In this tutorial, we're going to show how to extend Gloo with a plugin.

Plugins allow Gloo to expose new configuration options 
to 
