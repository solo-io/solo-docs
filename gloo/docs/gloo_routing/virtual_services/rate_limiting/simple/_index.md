...
Refer to the [Gloo external authentication]({{% ref "/gloo_routing/virtual_services/authentication/external_auth" %}}) documentation on how to configure Gloo to authenticate users.
