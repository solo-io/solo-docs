...
### Installation:
* [Installing locally Docker-Compose](installation/docker): Installation guide for Docker-Compose (easiest way to get started)
* [Installing on Kubernetes](installation/kubernetes): Installation guide for Kubernetes

### Getting Started:
* [Getting Started on Docker-Compose](getting_started/docker): Getting started with Docker (recommended for first time users)
* [Getting Started on Kubernetes](getting_started/kubernetes): Getting started with Kubernetes (recommended for first time users)
